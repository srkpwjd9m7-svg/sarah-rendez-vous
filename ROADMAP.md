...
| 2026-06-20 | Corriger l'affichage du choix `Invitation obligatoire` | Le selecteur du formulaire accepte maintenant 3 boutons meme sur petit ecran, et `index.html` force le rechargement des nouveaux assets (`app.css?v=6`, `app.js?v=4`). |
| 2026-06-20 | Retirer `Ajouter direct` | Toute creation passe maintenant par une invitation visible par l'autre personne avant apparition dans le calendrier. |
